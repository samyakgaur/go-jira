...
[![GoDoc](https://godoc.org/github.com/samyakgaur/go-jira?status.svg)](https://godoc.org/github.com/samyakgaur/go-jira)
[![Build Status](https://github.com/samyakgaur/go-jira/actions/workflows/testing.yml/badge.svg)](https://github.com/samyakgaur/go-jira/actions/workflows/testing.yml)
[![Go Report Card](https://goreportcard.com/badge/github.com/samyakgaur/go-jira)](https://goreportcard.com/report/github.com/samyakgaur/go-jira)
...
```bash
go get github.com/samyakgaur/go-jira
```
...
import (
	jira "gopkg.in/samyakgaur/go-jira.v1"
)
...
```
...
```bash
cd $GOPATH/src/github.com/samyakgaur/go-jira
go test -v ./...
```

## API

Please have a look at the [GoDoc documentation](https://godoc.org/github.com/samyakgaur/go-jira) for a detailed API description.
...
A few more examples are available in the [GoDoc examples section](https://godoc.org/github.com/samyakgaur/go-jira#pkg-examples).
...
For more details have a look at the [issue #56](https://github.com/samyakgaur/go-jira/issues/56).
...
please look at [Pagination Example](https://github.com/samyakgaur/go-jira/blob/master/examples/pagination/main.go)
...
* [samyakgaur/jitic](https://github.com/samyakgaur/jitic) - The Jira Ticket Checker
...
Creating issues or holding talks and help other people to use [go-jira](https://github.com/samyakgaur/go-jira) is contribution, too!
A few examples:

* Correct typos in the README / documentation
* Reporting bugs
* Implement a new feature or endpoint
* Sharing the love of [go-jira](https://github.com/samyakgaur/go-jira) and help people to get use to it
...
[https://github.com/samyakgaur/go-jira/releases/edit/v1.11.0](https://github.com/samyakgaur/go-jira/releases/edit/v1.11.0)
